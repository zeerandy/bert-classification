...
flags.DEFINE_string("task_name", "Finatt", "The name of the task to train.")
...
class FinattProcessor(DataProcessor):
    """Processor for the Finnum data set (GLUE version)."""
    def __init__(self):
        self.language = "zh"
    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            def metric_fn(per_example_loss, label_ids, logits):
                ...
                #micro = sklearn.metrics.f1_score(label_ids, predictions, average="micro")
                #macro = sklearn.metrics.f1_score(label_ids, predictions, average="macro")
                return {
...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        tf.logging.info("  label_list= %s", str(label_list))
    ...
    if FLAGS.do_predict:
        predict_examples,placeholder_labels = processor.get_test_examples(FLAGS.data_dir)
